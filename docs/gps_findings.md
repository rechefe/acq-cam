...
*Written for a signal-processing reader. For the algorithm derived from first
principles, with the domain vocabulary defined as it goes, see
[`gps_algorithm_explained.md`](gps_algorithm_explained.md).*
